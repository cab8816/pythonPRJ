    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('psyj', models.CharField(max_length=500, verbose_name='依据的管理体系文件/检测标准')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('importtype', models.CharField(choices=[('0', '0_读取评审通知(docx格式)'), ('1', '1_读取评审报告(docx格式)'), ('2', '2_评审员信息表格(docx格式)'), ('3', '3_现场评审核查表(docx格式)')], default=0, max_length=1, verbose_name='导入类型')),
