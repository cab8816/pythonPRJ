# Generated by Django 2.0 on 2020-08-13 13:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('psxxb', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='Myapp.Pingshenxxb', verbose_name='评审信息')),
                ('psyuanb', models.ManyToManyField(to='Myapp.Psyuanb')),
            ],
            options={
                'verbose_name': '评审组组成表',
        ...
        migrations.AddField(
            model_name='psyuanb',
            name='psy_detail',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Myapp.PsyuanDetail'),
        ),
        migrations.AddField(
            model_name='biao72',
            name='psxxb',
