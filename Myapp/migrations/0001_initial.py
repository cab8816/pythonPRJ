# Generated by Django 3.0.7 on 2020-08-12 04:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('psy_detail', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='Myapp.PsyuanDetail')),
            ],
            options={
                'verbose_name': '评审员表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('psyh', models.ManyToManyField(to='Myapp.Psyuanb')),
            ],
            options={
                'verbose_name': '评审信息总表',
